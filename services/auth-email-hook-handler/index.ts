...
export const shopifyHandler = async (
  ...
  // The account-service email-add flow verifies in the logged-in session on a
  // dedicated page (link + confirm identities), vs the normal signup page.
  const verifyPath =
    event.request.clientMetadata?.flow === "account-email"
